package com.williammacedo.bookstoremanager.exception;
...
public class BookstoreExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        exception.getBindingResult().getFieldErrors()
            .forEach(fieldError -> errors.add(String.format("Field: %s %s",fieldError.getField().toUpperCase(), fieldError.getDefaultMessage())));
        exception.getBindingResult().getGlobalErrors()
            .forEach(globalErrors -> errors.add(String.format("Field: %s %s",globalErrors.getObjectName().toUpperCase(), globalErrors.getDefaultMessage())));
